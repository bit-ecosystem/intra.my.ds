...
<x-filament-widgets::widget>
    @php
        // The widget exposes getCategories(), same shape as the Filament demo expects.
        // You can also pass $categories from getViewData() if you prefer.
    ...
    <div class="mt-6 space-y-6">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400">
                    Click any feature to open the Courses list filtered by that category
                </p>
            </div>
        ...
        <div class="columns-1 gap-6 space-y-6 md:columns-2 xl:columns-3">
            @foreach ($categories as $category)
                @php $c = $colors[$category['color']] ?? $colors['gray']; @endphp
                    ...
                    <div class="flex items-center gap-3 px-5 pt-4 pb-3">
                        ...
                        <div class="min-w-0">
                            ...
                            <p class="text-xs text-gray-500 dark:text-gray-400">
                                {{ count($category['features']) }} {{ \Illuminate\Support\Str::plural('feature', count($category['features'])) }}
                            </p>
                        </div>
                    </div>
