...
class CourseSeeder extends Seeder
{
    public function run(): void
    {
        $courses = [
            ...
            ['code' => 'EQ-DICER',       'title' => 'Wafer Dicer Machine',        'coursegroup' => CourseGroup::EQUIPMENT, 'description' => 'Equipment classes, operation, and maintenance topics: wafer dicer.', 'status' => 'published'],
            ['code' => 'EQ-DIE-BONDER',  'title' => 'Die Bonder Machine',         'coursegroup' => CourseGroup::EQUIPMENT, 'description' => 'Equipment classes, operation, and maintenance topics: die bonder.', 'status' => 'published'],
            ['code' => 'EQ-FLIP-CHIP',   'title' => 'Flip Chip Bonder Machine',   'coursegroup' => CourseGroup::EQUIPMENT, 'description' => 'Equipment classes, operation, and maintenance topics: flip-chip bonder.', 'status' => 'published'],
            ['code' => 'EQ-WIRE-BONDER', 'title' => 'Wire Bonder Machine',        'coursegroup' => CourseGroup::EQUIPMENT, 'description' => 'Equipment classes, operation, and maintenance topics: wire bonder.', 'status' => 'published'],
            ['code' => 'EQ-MOLD',        'title' => 'Molding Press Machine',      'coursegroup' => CourseGroup::EQUIPMENT, 'description' => 'Equipment classes, operation, and maintenance topics: molding press.', 'status' => 'published'],
            ['code' => 'EQ-TRIM-FORM',   'title' => 'Trim & Form Machine Machine', 'coursegroup' => CourseGroup::EQUIPMENT, 'description' => 'Equipment classes, operation, and maintenance topics: trim & form.', 'status' => 'published'],
            ['code' => 'EQ-PLATING',     'title' => 'Plating Line Machine',       'coursegroup' => CourseGroup::EQUIPMENT, 'description' => 'Equipment classes, operation, and maintenance topics: plating line.', 'status' => 'published'],
            ['code' => 'EQ-MARK',        'title' => 'Laser Marker Machine',       'coursegroup' => CourseGroup::EQUIPMENT, 'description' => 'Equipment classes, operation, and maintenance topics: laser marker.', 'status' => 'published'],
            ['code' => 'EQ-SINGULATION', 'title' => 'Singulation Saw/Router Machine',   'coursegroup' => CourseGroup::EQUIPMENT, 'description' => 'Equipment classes, operation, and maintenance topics: singulation saw/router.', 'status' => 'published'],
            ['code' => 'EQ-AOI',         'title' => 'AOI Machine Machine',        'coursegroup' => CourseGroup::EQUIPMENT, 'description' => 'Equipment classes, operation, and maintenance topics: AOI machine.', 'status' => 'published'],
            ['code' => 'EQ-XRAY',        'title' => 'X‑ray Inspection Machine Machine',  'coursegroup' => CourseGroup::EQUIPMENT, 'description' => 'Equipment classes, operation, and maintenance topics: X‑ray inspection machine.', 'status' => 'published'],
            ['code' => 'EQ-TESTER',      'title' => 'Automated Test Equipment Machine',  'coursegroup' => CourseGroup::EQUIPMENT, 'description' => 'Equipment classes, operation, and maintenance topics: automated test equipment.', 'status' => 'published'],
            ['code' => 'EQ-BURNIN',      'title' => 'Burn‑in Chamber Machine',   'coursegroup' => CourseGroup::EQUIPMENT, 'description' => 'Equipment classes, operation, and maintenance topics: burn‑in chamber.', 'status' => 'published'],
            ['code' => 'EQ-REWORK',      'title' => 'Rework Station Machine',    'coursegroup' => CourseGroup::EQUIPMENT, 'description' => 'Equipment classes, operation, and maintenance topics: rework station.', 'status' => 'published'],
